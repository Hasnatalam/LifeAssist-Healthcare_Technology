...
public class UserAuthService {
    ...
    public AuthResponse register(GuardianRegisterRequest request) {
        ...
        var caretaker = userRepository.findByEmail(request.getCaretakerUsername())
                .orElseThrow(() -> new UserNotFoundException("User not found with email: " + request.getCaretakerUsername()));
